  ...
  return (
    <header
      className={cn(
        ...
        scrolled
          ? "top-3 left-4 right-4 md:left-6 md:right-6 lg:left-8 lg:right-8 rounded-full bg-white/15 dark:bg-[#0f0f0f]/15 backdrop-blur-md border border-white/20 dark:border-white/10 shadow-lg shadow-black/10 dark:shadow-black/40"
